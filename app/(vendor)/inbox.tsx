// app/(vendor)/inbox.tsx – Real vendor chat list from Firestore
...
export default function VendorInboxScreen() {
    ...
    const loadChats = async () => {
        ...
        try {
            const vendorChats = await getUserChats(user.uid, true);
            setChats(vendorChats.sort((a, b) => 
    ...
    const renderChat = ({ item }: { item: Chat }) => (
        ...
        >
            ...
            <View style={{ flex: 1 }}>
                <Text style={styles.convTitle}>{item.userName}</Text>
